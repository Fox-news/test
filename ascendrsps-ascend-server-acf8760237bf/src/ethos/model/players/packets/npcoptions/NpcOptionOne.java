...
case 4625:
	...
	break;
		...
		case 3913://small net fishing
			player.getFishing2().startFishing(npcType,303);
			break;
		case 3417://fly fishing
			player.getFishing2().startFishing(npcType,309);
			break;
		case 3657://lobster cage
			player.getFishing2().startFishing(npcType,301);
			break;
		case 1520://monkfish
			player.getFishing2().startFishing(npcType,305);
			break;
		case 6825://angler
			player.getFishing2().startFishing(npcType,307);
			break;
		case 635://dark crab
			player.getFishing2().startFishing(npcType,301);
			break;
		case 4712://karambwan
			player.getFishing2().startFishing(npcType,3157);
			break;
